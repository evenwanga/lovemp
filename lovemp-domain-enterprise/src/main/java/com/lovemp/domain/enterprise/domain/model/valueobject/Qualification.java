...
public class Qualification implements ValueObject {
    ...
    public static Qualification of(
        ...
        if (type == null) {
            throw new DomainRuleViolationException("资质类型不能为空");
        }
        
        if (StringUtils.isEmpty(name)) {
            throw new DomainRuleViolationException("资质名称不能为空");
        }
        
        if (StringUtils.isEmpty(qualificationNumber)) {
            throw new DomainRuleViolationException("资质编号不能为空");
        }
